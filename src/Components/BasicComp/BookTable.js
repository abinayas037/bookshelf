    ...
    return (
        ...
        <Table className={classes.table}>
          <TableBody>
              ...
              {
                  (data.canonicalVolumeLink) ? <BookCell name="Open In Play Books" value={(<a href={data.canonicalVolumeLink} target="blank">Open</a>)} />  : null
              }
              {
                  (data.previewLink) ? <BookCell name="Open Preview" value={(<a href={data.previewLink} target="blank">Open</a>)} />  : null
              }
              {
